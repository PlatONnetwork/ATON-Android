 ...
 */
package com.juzhen.framework.network.download;

import android.text.TextUtils;
import android.util.Log;
import com.juzhen.framework.network.Connection;
import com.juzhen.framework.network.Headers;
import com.juzhen.framework.network.HttpConnection;
import com.juzhen.framework.network.Logger;
import com.juzhen.framework.network.NetworkExecutor;
import com.juzhen.framework.network.NoHttp;
import com.juzhen.framework.network.error.NetworkError;
import com.juzhen.framework.network.error.ServerError;
import com.juzhen.framework.network.error.StorageReadWriteError;
import com.juzhen.framework.network.error.StorageSpaceNotEnoughError;
import com.juzhen.framework.network.error.TimeoutError;
import com.juzhen.framework.network.error.URLError;
import com.juzhen.framework.network.error.UnKnownHostError;
import com.juzhen.framework.network.tools.HeaderUtils;
import com.juzhen.framework.network.tools.IOUtils;
import com.juzhen.framework.network.tools.NetUtils;
