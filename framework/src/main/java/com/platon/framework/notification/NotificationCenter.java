...
public class NotificationCenter {
    ...
    protected boolean subscribe(final Object classTopicOrPatternWrapper, final Map<Object, Object> subscriberMap, final Object subscriber) {
        ...
        synchronized (listenerLock) {
            ...
            if (currentSubscribers == null) {
                Log.error(TAG, "Creating new subscriber map for:" + classTopicOrPatternWrapper);
     ...
     * @param subscriber    the subscriber to unsubscribe, either an EventSubscriber or an EventTopicSubscriber, or a WeakReference to either
