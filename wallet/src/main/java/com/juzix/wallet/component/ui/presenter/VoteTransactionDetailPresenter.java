 ...
 */
public class VoteTransactionDetailPresenter extends BasePresenter<VoteTransactionDetailContract.View> implements VoteTransactionDetailContract.Presenter {

    private Transaction mTransaction;
    private String mQueryAddress;

    public VoteTransactionDetailPresenter(VoteTransactionDetailContract.View view) {
        super(view);
