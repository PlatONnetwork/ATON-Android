...
//        int      size    = (int) (AndroidUtil.getWindowWith(activity) * (200.0f / 376.0f));
//        Bitmap   bitmap  = EncodingHandler.createQRCode(activity.getIntent().getStringExtra(Constants.Extra.EXTRA_PASSWORD), size, size, null);
//        if (bitmap != null) {
