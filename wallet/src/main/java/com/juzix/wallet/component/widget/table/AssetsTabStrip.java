package com.juzix.wallet.component.widget.table;
...
public class AssetsTabStrip extends LinearLayout {
    ...
    void setCustomTabColorizer(AssetsTabLayout.TabColorizer customTabColorizer) {
    ...
    AssetsTabLayout.TabColorizer getTabColorizer() {
