        ...
        for (String key : bundle.keySet()) {
            switch (key) {
                ...
                case VerifyNodeDiffCallback.KEY_DEPOSIT_DELEGATOR_NUMBER:
                    ...
                    mNodeDelegatedAmount.setText(String.format("%s / %s", mContext.getResources().getString(R.string.amount_with_unit, AmountUtil.convertVonToLatWithFractionDigits(deposit, 2)), StringUtil.formatBalance(delegatorNumber, 0, 0)));
                    break;
