package com.platon.aton.component.widget.bubbleSeekBar;
...
import static com.platon.aton.component.widget.bubbleSeekBar.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK;
import static com.platon.aton.component.widget.bubbleSeekBar.BubbleSeekBar.TextPosition.BOTTOM_SIDES;
import static com.platon.aton.component.widget.bubbleSeekBar.BubbleSeekBar.TextPosition.SIDES;
import static com.platon.aton.component.widget.bubbleSeekBar.BubbleUtils.dp2px;
import static com.platon.aton.component.widget.bubbleSeekBar.BubbleUtils.sp2px;
...
//    }
    ...
    public interface CustomSectionTextArray {
         ...
         * </p>
         * For example:
         * <com.platon.aton.pre> public SparseArray<String> onCustomize(int sectionCount, @NonNull SparseArray<String> array) {
         * array.clear();
         * <p>
         * array.put(0, "worst");
         * array.put(4, "bad");
