...
import com.platon.wallet.component.ui.dialog.DelegateSelectWalletDialogFragment;
import com.platon.wallet.component.ui.dialog.InputWalletPasswordDialogFragment;
import com.platon.wallet.component.ui.dialog.TransactionAuthorizationDialogFragment;
                ...
                .setOnItemClickListener(new DelegateSelectWalletDialogFragment.OnItemClickListener() {
                    ...
                    public void onItemClick(Wallet wallet) {
                        ServerUtils.getCommonApi().getGasProvider(ApiRequestBody.newBuilder()
                                ...
                                .subscribe(new ApiSingleObserver<com.platon.wallet.entity.GasProvider>() {
                                    @Override
                                    public void onApiSuccess(com.platon.wallet.entity.GasProvider gasProvider) {
                                        if (isViewAttached()) {
                                            mWallet = wallet;
