...
package com.platon.wallet.component.widget.togglebutton;
...
public class BaseSpringSystem {
  ...
  /**
   * notifyDataStatusChanged the springs in the system
   * @param deltaTime delta since last notifyDataStatusChanged in millis
   */
